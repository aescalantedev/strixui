      ...
      <Card className="w-full max-w-[400px] shadow-2xl border-border/50 rounded-2xl bg-card overflow-hidden">
        ...
        <CardContent className="space-y-8 p-8">
          <form className="space-y-4" onSubmit={(e) => e.preventDefault()}>
            ...
            <Button className="w-full h-12 rounded-xl bg-primary text-primary-foreground hover:bg-primary/90 font-bold tracking-tight text-sm shadow-lg shadow-primary/20 transition-all active:scale-[0.98] mt-2">
          ...
          <div className="grid grid-cols-2 gap-4 pb-2">
            <Button variant="outline" className="h-11 rounded-xl border-border hover:bg-secondary/50 font-bold text-xs gap-2 transition-all active:scale-[0.98] text-foreground shadow-sm">
              <svg className="h-4 w-4" role="img" viewBox="0 0 24 24" fill="currentColor">
                <path d="M22.56 12.25c0-.78-.07-1.53-.2-2.25H12v4.26h5.92c-.18 1-.78 1.85-1.63 2.42v2.01h2.64c1.55-1.42 2.43-3.5 2.43-5.44z"/>
                <path d="M12 23c2.97 0 5.46-.98 7.28-2.66l-2.64-2.01c-.73.48-1.66.76-2.64.76-2.85 0-5.27-1.92-6.13-4.51H2.18v2.07C3.99 20.53 7.7 23 12 23z"/>
                <path d="M5.87 14.59c-.22-.66-.35-1.36-.35-2.09s.13-1.43.35-2.09V8.34H2.18C1.43 9.81 1 11.45 1 13s.43 3.19 1.18 4.66l3.69-2.07z"/>
                <path d="M12 5.38c1.62 0 3.06.56 4.21 1.64l3.15-3.15C17.45 2.09 14.97 1 12 1 7.7 1 3.99 3.47 2.18 7.07l3.69 2.07c.86-2.59 3.28-4.51 6.13-4.51z"/>
              </svg>
              Google
            </Button>
            <Button variant="outline" className="h-11 rounded-xl border-border hover:bg-secondary/50 font-bold text-xs gap-2 transition-all active:scale-[0.98] text-foreground shadow-sm">
