...
export default function GlobalError({
  ...
  return (
    <div className="min-h-[100dvh] w-full flex flex-col items-center justify-center p-6 bg-background relative z-[100] font-sans selection:bg-primary/10 selection:text-primary overflow-hidden">
      ...
      <div className="flex flex-col items-center text-center animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div className="relative">
           ...
           {/* Decorative lightning or pulse could go here */}
        </div>
      ...
      {/* TECHNICAL DETAILS (OPTIONAL/SUTILE) */}
      <div className="absolute bottom-10 flex flex-col items-center gap-2 opacity-10 pointer-events-none">
         <span className="text-[9px] font-black uppercase tracking-widest">Global Error Boundary</span>
